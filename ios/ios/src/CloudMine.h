 ...
 * The native iOS library allows you to interact with your CloudMine remote data store, create and manage user accounts, as well as execute your custom server-side code snippets all in a clean object-oriented fashion and without having to manage connection pools or assemble URLs.
 *
 ...
 *
 * The most important classes to know are <a href="interface_c_m_store.html"><strong>CMStore</strong></a> and <a href="interface_c_m_user.html"><strong>CMUser</strong></a>. <strong>CMStore</strong> is like a box for all your app's <a href="http://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller#Concepts" target="_blank">models</a>. All your store and retrieve operations are coordinated through it. <strong>CMUser</strong> represents an account for a user of your app. See the <a href="interface_c_m_user.html">framework reference</a> for more details on users, security, and session tokens.
 *
 ...
 *
 * If you need to store geospatial information with any of your objects, use an instance of the provided <strong><a href="interface_c_m_geo_point.html">CMGeoPoint</a></strong> class.
 *
 ...
 * - libz
 *
 * The <a href="https://cloudmine.me/developer_zone#ios/tutorials" target="_blank">video walkthrough</a> below shows you exactly how to do this.
 */
