...
#import "NSMutableURLRequest+CMOAuth.h"
#import "NSURL+CMOAuth.h"
//#import "NSData+Base64.h"
#import <CommonCrypto/CommonHMAC.h>

@implementation NSMutableURLRequest (CMOAuth)
...

{
    ...
    NSString *authorizationHeader = OAuthorizationHeader(URL, method, bodyData, consumerKey, secretKey, token, authTokenSecret);
...
NSString *OAuthorizationHeader(NSURL *url, NSString *method, NSData *body, NSString *_oAuthConsumerKey, NSString *_oAuthConsumerSecret, NSString *_oAuthToken, NSString *_oAuthTokenSecret)
{
    ...
    NSString *base64Signature = nil; //[signature base64EncodedString];
